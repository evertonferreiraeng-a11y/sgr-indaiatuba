  ...
  return `
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="planos-acao.html">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M8 21h8M12 17v4M7 4h10v6a5 5 0 0 1-10 0V4z"/><path d="M17 6h3a2 2 0 0 1-2 3.5M7 6H4a2 2 0 0 0 2 3.5"/></svg>
          Planos de Ação
        </a>
        <a href="plano-expansao.html">
